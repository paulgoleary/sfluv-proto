...
export interface IAccessControlDefaultAdminRulesInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IAccessControlDefaultAdminRules extends BaseContract {
  connect(runner?: ContractRunner | null): IAccessControlDefaultAdminRules;
  ...
  pendingDefaultAdmin: TypedContractMethod<
    [],
    [[string, bigint] & { newAdmin: string; acceptSchedule: bigint }],
    "view"
  >;

  pendingDefaultAdminDelay: TypedContractMethod<
    [],
    [[bigint, bigint] & { newDelay: bigint; effectSchedule: bigint }],
    "view"
  >;
